...
class VO(PathConfig):
    ...
    def _set_user_path(self):
        ...
        self._user_path = os.path.join(self.MEDIA_PATH, self._username)

    def get_user_diary_file_path(self, post_id: int):
        self._set_user_variables(post_id)
        self._set_user_path()
        return os.path.join(self._user_path, f"{self._username}_{str(post_id)}.png")
    ...
    def get_user_word_cloud_path(self, post_id: int):
        ...
        return os.path.join(self._user_path, f"{self._username}_{str(post_id)}_word_cloud.png")
